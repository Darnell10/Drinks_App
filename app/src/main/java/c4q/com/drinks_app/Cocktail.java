...
public class Cocktail {
    ...
    public String getIdDrink() { return this.idDrink; }

    public void setIdDrink(String idDrink) { this.idDrink = idDrink; }

    private String strDrink;

    public String getStrDrink() { return this.strDrink; }
...
//
//    public void setDrinks(ArrayList<Drink> drinks) { this.drinks = drinks; }
//}
